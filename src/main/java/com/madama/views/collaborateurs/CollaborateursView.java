...
@Route(value = "mates", layout = MainLayout.class)
@PermitAll
public class CollaborateursView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public CollaborateursView() {
        addClassName("collaborateurs-view");
        setSizeFull();
        grid.setHeight("100%");
